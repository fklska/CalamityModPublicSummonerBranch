# Summoner Branch
В Этой ветке убрано ограничение на призывателя, которое не позволяет стакать артефакты, которые увеличивывают максимальное количество миньонов. Что бы установить эту ветку нужно воспользоватьтся интерфейсом TModLoader (Разработка модов). 
1. Нужно скачать .NET 8
2. Закинуть в папку ModSourсes данный репозиторий (C:\...\Documents\My Games\Terraria\tModLoader\ModSources). Она создаться автоматически TModLoaderom, чтобы ее открыть нажмите "открыть исходники". ![изображение](https://github.com/user-attachments/assets/5cbd6b4c-3146-410a-b909-868cca3caeb5)
3. Переимоновать папку репозитория с "CalamityModPublicSummonerBranch" в "CalamityMod". Иначе у вас будет возникать ошибка при загрузке мода связанная с нарушением пространства имен.
4. Нажать "Скомпилировать и перезагрузить"
5. Готово! Чтобы не перепутать мод он имеет другое отображаемое имя, также он будет помечен как локальный мод.
  ![изображение](https://github.com/user-attachments/assets/a164b79e-6ab7-4e9b-ad10-383130affb70)
